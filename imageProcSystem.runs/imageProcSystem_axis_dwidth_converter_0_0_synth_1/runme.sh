...
HD_PWD='D:/Kishore_Sir_Project/imageProcSystem/imageProcSystem.runs/imageProcSystem_axis_dwidth_converter_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log imageProcSystem_axis_dwidth_converter_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source imageProcSystem_axis_dwidth_converter_0_0.tcl

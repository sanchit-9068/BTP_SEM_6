...
read_ip -quiet d:/Kishore_Sir_Project/imageProcSystem/imageProcSystem.srcs/sources_1/bd/imageProcSystem/ip/imageProcSystem_axi_smc_0/imageProcSystem_axi_smc_0.xci
...
set cached_ip [config_ip_cache -export -no_bom -use_project_ipc -dir D:/Kishore_Sir_Project/imageProcSystem/imageProcSystem.runs/imageProcSystem_axi_smc_0_synth_1 -new_name imageProcSystem_axi_smc_0 -ip [get_ips imageProcSystem_axi_smc_0]]

if { $cached_ip eq {} } {
close [open __synthesis_is_running__ w]

synth_design -top imageProcSystem_axi_smc_0 -part xc7z010clg400-1 -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix imageProcSystem_axi_smc_0_ imageProcSystem_axi_smc_0.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ imageProcSystem_axi_smc_0_stub.v
 lappend ipCachedFiles imageProcSystem_axi_smc_0_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ imageProcSystem_axi_smc_0_stub.vhdl
 lappend ipCachedFiles imageProcSystem_axi_smc_0_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ imageProcSystem_axi_smc_0_sim_netlist.v
 lappend ipCachedFiles imageProcSystem_axi_smc_0_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ imageProcSystem_axi_smc_0_sim_netlist.vhdl
 lappend ipCachedFiles imageProcSystem_axi_smc_0_sim_netlist.vhdl
set TIME_taken [expr [clock seconds] - $TIME_start]

 config_ip_cache -add -dcp imageProcSystem_axi_smc_0.dcp -move_files $ipCachedFiles -use_project_ipc  -synth_runtime $TIME_taken  -ip [get_ips imageProcSystem_axi_smc_0]
}

rename_ref -prefix_all imageProcSystem_axi_smc_0_

# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef imageProcSystem_axi_smc_0.dcp
create_report "imageProcSystem_axi_smc_0_synth_1_synth_report_utilization_0" "report_utilization -file imageProcSystem_axi_smc_0_utilization_synth.rpt -pb imageProcSystem_axi_smc_0_utilization_synth.pb"

if { [catch {
  file copy -force D:/Kishore_Sir_Project/imageProcSystem/imageProcSystem.runs/imageProcSystem_axi_smc_0_synth_1/imageProcSystem_axi_smc_0.dcp d:/Kishore_Sir_Project/imageProcSystem/imageProcSystem.srcs/sources_1/bd/imageProcSystem/ip/imageProcSystem_axi_smc_0/imageProcSystem_axi_smc_0.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub d:/Kishore_Sir_Project/imageProcSystem/imageProcSystem.srcs/sources_1/bd/imageProcSystem/ip/imageProcSystem_axi_smc_0/imageProcSystem_axi_smc_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub d:/Kishore_Sir_Project/imageProcSystem/imageProcSystem.srcs/sources_1/bd/imageProcSystem/ip/imageProcSystem_axi_smc_0/imageProcSystem_axi_smc_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim d:/Kishore_Sir_Project/imageProcSystem/imageProcSystem.srcs/sources_1/bd/imageProcSystem/ip/imageProcSystem_axi_smc_0/imageProcSystem_axi_smc_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim d:/Kishore_Sir_Project/imageProcSystem/imageProcSystem.srcs/sources_1/bd/imageProcSystem/ip/imageProcSystem_axi_smc_0/imageProcSystem_axi_smc_0_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force D:/Kishore_Sir_Project/imageProcSystem/imageProcSystem.runs/imageProcSystem_axi_smc_0_synth_1/imageProcSystem_axi_smc_0_stub.v d:/Kishore_Sir_Project/imageProcSystem/imageProcSystem.srcs/sources_1/bd/imageProcSystem/ip/imageProcSystem_axi_smc_0/imageProcSystem_axi_smc_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force D:/Kishore_Sir_Project/imageProcSystem/imageProcSystem.runs/imageProcSystem_axi_smc_0_synth_1/imageProcSystem_axi_smc_0_stub.vhdl d:/Kishore_Sir_Project/imageProcSystem/imageProcSystem.srcs/sources_1/bd/imageProcSystem/ip/imageProcSystem_axi_smc_0/imageProcSystem_axi_smc_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force D:/Kishore_Sir_Project/imageProcSystem/imageProcSystem.runs/imageProcSystem_axi_smc_0_synth_1/imageProcSystem_axi_smc_0_sim_netlist.v d:/Kishore_Sir_Project/imageProcSystem/imageProcSystem.srcs/sources_1/bd/imageProcSystem/ip/imageProcSystem_axi_smc_0/imageProcSystem_axi_smc_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force D:/Kishore_Sir_Project/imageProcSystem/imageProcSystem.runs/imageProcSystem_axi_smc_0_synth_1/imageProcSystem_axi_smc_0_sim_netlist.vhdl d:/Kishore_Sir_Project/imageProcSystem/imageProcSystem.srcs/sources_1/bd/imageProcSystem/ip/imageProcSystem_axi_smc_0/imageProcSystem_axi_smc_0_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir D:/Kishore_Sir_Project/imageProcSystem/imageProcSystem.ip_user_files/ip/imageProcSystem_axi_smc_0]} {
  catch { 
    file copy -force d:/Kishore_Sir_Project/imageProcSystem/imageProcSystem.srcs/sources_1/bd/imageProcSystem/ip/imageProcSystem_axi_smc_0/imageProcSystem_axi_smc_0_stub.v D:/Kishore_Sir_Project/imageProcSystem/imageProcSystem.ip_user_files/ip/imageProcSystem_axi_smc_0
  }
}

if {[file isdir D:/Kishore_Sir_Project/imageProcSystem/imageProcSystem.ip_user_files/ip/imageProcSystem_axi_smc_0]} {
  catch { 
    file copy -force d:/Kishore_Sir_Project/imageProcSystem/imageProcSystem.srcs/sources_1/bd/imageProcSystem/ip/imageProcSystem_axi_smc_0/imageProcSystem_axi_smc_0_stub.vhdl D:/Kishore_Sir_Project/imageProcSystem/imageProcSystem.ip_user_files/ip/imageProcSystem_axi_smc_0
  }
}

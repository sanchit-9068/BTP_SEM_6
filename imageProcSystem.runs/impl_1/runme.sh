...
HD_PWD='D:/Kishore_Sir_Project/imageProcSystem/imageProcSystem.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log imageProcSystem_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source imageProcSystem_wrapper.tcl -notrace

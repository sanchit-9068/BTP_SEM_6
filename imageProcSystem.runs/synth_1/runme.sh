...
HD_PWD='D:/Kishore_Sir_Project/imageProcSystem/imageProcSystem.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log imageProcSystem_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source imageProcSystem_wrapper.tcl

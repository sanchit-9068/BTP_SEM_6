...
HD_PWD='D:/Kishore_Sir_Project/IP_repo/imageProc/imageProc.runs/outputBuffer_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log outputBuffer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source outputBuffer.tcl
